...
class MLP(nn.Module):
    def __init__(self, dim: int = 256):
        ...
        print(f'Weight of the first linear layer: {self.dense_1.weight.transpose(0, 1).shape}')
        self.activation = nn.ReLU()
        self.dense_2 = nn.Linear(intermediate_dim, dim)
        print(f'Weight of the second linear layer: {self.dense_2.weight.transpose(0, 1).shape}')
