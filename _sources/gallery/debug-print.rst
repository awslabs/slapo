...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    linear1 shape
     torch.Size([2, 2, 4]) 
    value
     tensor([[[-0.5080, -0.0799,  0.2108,  0.2658],
             [-1.8848, -0.6675, -0.9922,  1.6436]],

            [[-0.3748, -0.1069,  1.0580,  0.2357],
             [ 0.0690, -0.5098, -0.2417,  0.0064]]], grad_fn=<ViewBackward0>)

    tensor([[[-0.3676,  0.1934,  0.4278, -0.2827],
             [-0.9365,  0.6794, -0.0037, -0.5021]],

            [[-0.0293,  0.5467,  0.5680, -0.2643],
             [-0.4899,  0.0178,  0.4681, -0.3435]]], grad_fn=<ViewBackward0>)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[[-0.2534, -0.3875,  0.3296,  0.1623],
             [ 0.4856, -0.4088,  0.4194,  0.4941]],

            [[-0.1112, -0.3545, -0.0350,  0.3380],
             [ 0.3857, -0.4663,  0.5647,  0.3396]]], grad_fn=<ViewBackward0>)
