...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    linear1 shape
     torch.Size([2, 2, 4]) 
    value
     tensor([[[ 1.9195,  1.0762, -0.5582, -0.3729],
             [ 0.2868,  0.3821, -0.0204, -1.0652]],

            [[-0.6296, -0.5585,  0.0393, -0.6891],
             [ 0.1510, -0.1476, -0.1224, -0.0103]]], grad_fn=<ViewBackward0>)

    tensor([[[-0.2597,  0.3035, -0.3437, -1.1804],
             [ 0.2327,  0.2039,  0.2464, -0.5660]],

            [[ 0.3334,  0.2659,  0.4033, -0.4374],
             [ 0.2529,  0.2130,  0.3921, -0.4953]]], grad_fn=<ViewBackward0>)
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    tensor([[[ 0.1710,  0.2315, -0.2130, -0.0753],
             [ 0.3953,  0.1141, -0.5045, -0.0640]],

            [[ 0.5521,  0.0531, -0.5726,  0.0107],
             [ 0.5379,  0.3046, -0.0292,  0.0690]]], grad_fn=<ViewBackward0>)
